...
namespace Discord
{
    ...
    public partial class ActivityManager
    {
        ...
        FFIMethods.UpdateActivityCallback lastCallback = null;

        public void UpdateActivity(Activity activity, UpdateActivityHandler callback)
        {
            GCHandle wrapped = GCHandle.Alloc(callback);
            lastCallback = new FFIMethods.UpdateActivityCallback(UpdateActivityCallbackImpl);
            Methods.UpdateActivity(MethodsPtr, ref activity, GCHandle.ToIntPtr(wrapped), lastCallback);
        }
